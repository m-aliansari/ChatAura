...
router.post(API_ROUTES.FCM.SPECIFIC.TOKEN.SAVE, rateLimiter(60, 10), handleFCMTokenSave);

router.post(API_ROUTES.FCM.SPECIFIC.TOKEN.DELETE, rateLimiter(60, 10), handleFCMTokenDelete);
