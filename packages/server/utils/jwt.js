 ...
 */
export const jwtSignPromise = (payload, options) => new Promise((resolve) => {
 ...
 */
export const jwtVerifyPromise = (token) => new Promise((resolve) => {
 ...
 * @returns {string | null}
 */
export const getJwtTokenFromRequest = req => req.headers["authorization"]?.split(" ")?.[1] ?? null